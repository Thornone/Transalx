  ...
  <div class="wrapper-body">
    ...
    <div class="section-heading-page">
      <div class="container">
        <div class="row">
          <div class="col-sm-6">
            <h1 class="heading-page text-center-xs">Electronic Export</h1>
          </div>
          <div class="col-sm-6">
...
<div class="col-sm-12">
       ...
       <h1>Features
       <br>
       <small>Electronic Export (AES)</small>   
       <br>
...
<div class="text-center-xs">
       ...
       <br>
              <small>
         - EEI Dashboard Control
       </small>
       <br>
       <small>
         - Systems Interface (Aduasis, Global PC)
       </small><br>
       <small>
         - ETL from (XML, PDF, TXT, XLS, Web)
       </small><br>
       <small>
         - Billing Integration
       </small>
