  ...
  <div class="wrapper-body">
    ...
    <div class="section-heading-page">
      <div class="container">
        <div class="row">
          <div class="col-sm-6">
            <h1 class="heading-page text-center-xs">Accounting System</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb text-right text-center-xs">
              ...
              <li class="active">Accounting System</li>
            </ol>
          </div>
        </div>
      </div>
...
<div class="col-sm-12">
            ...
            <img class="img-responsive center-block" src="img/Accounting.jpg" alt="theme-img">
...
<div class="text-center-xs">
       ...
       <br>
              <small>
         - Billing Control by Traffic
       </small>
       <br>
       <small>
         - Invoice Types (Service, Duties)
       </small><br>
       <small>
         - Customer Service Rates
       </small><br>
       <small>
         - Bulk or By Item Control
       </small><br>
       <small>
         - Customer Statement
       </small><br>
