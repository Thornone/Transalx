            ...
            <div class="carousel-inner">
              ...
              <div class="item item-theme-first active">
                <div class="container">
                  <div class="row">
                    <div class="col-sm-7">
                      <h1 class="text-theme title-xl mt-40 animation an-delay-05 an-duration-04 fadeInLeftSlider">Testimonials</h1>
                      <p class="text-theme an-delay-09 an-duration-04 fadeInUpSlider">My company has been in business since 2000, we learned about IMEXSOL and the experience you have with ABI along with your knowledge of the import process in Laredo TX. We decided to take a chance with your company but I am happy to say, I am glad we did. You were able to personalize your program to fit our needs and allow us to minimize effort and time into every entry. You have also proven to give excellent service by always being there when we need you. It is a pleasure doing business with IMEXSOL and we look forward to a long term relationship. Sincerely, </p> <br> 
                      <p class="text-theme an-delay-09 an-duration-04 fadeInUpSlider">Jason P. Leyendecker CHB </p>
                       <p class="text-theme an-delay-09 an-duration-04 fadeInUpSlider">Leyendecker Logistics Co. </p>
                    </div>
...
<div class="col-sm-6">
  <h1>They Support Us.
       <br>
       <small>‘There is only one boss, the customer. And he can fire everybody in the company from the chairman on down, simply by spending his money  somewhere else’</small> <br>
       <small>Sam Walton</small>
</div>
<div class="col-sm-6">

            <img class="img-responsive center-block" src="img/supp.png" alt="theme-img">
