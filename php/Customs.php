  ...
  <div class="wrapper-body">
    ...
    <div class="section-heading-page">
      <div class="container">
        <div class="row">
          <div class="col-sm-6">
            <h1 class="heading-page text-center-xs">Customs Clearance</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb text-right text-center-xs">
              ...
              <li class="active">Customs Clearance</li>
            </ol>
          </div>
        </div>
      </div>
...
<div class="col-sm-12">
            ...
            <img class="img-responsive center-block" src="img/customs.png" alt="theme-img">
...
<div class="text-center-xs">
       ...
       <br>
              <small>
         - Entries, Inbonds, ISF dashboards
       </small>
       <br>
       <small>
         - Customer Profiles
