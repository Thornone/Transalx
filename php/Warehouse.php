  ...
  <div class="wrapper-body">
    ...
    <div class="section-heading-page">
      <div class="container">
        <div class="row">
          <div class="col-sm-6">
            <h1 class="heading-page text-center-xs">ACE Manifest</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb text-right text-center-xs">
              ...
              <li class="active">US Truck E-Manifest</li>
            </ol>
          </div>
        </div>
      </div>
...
<div class="text-center-xs">
       ...
       <br>
              <small>
         - Input Advance Shipping Notifications
       </small>
       <br>
       <small>
         - Parcel Receipts on Mobile Devices
       </small><br>
       <small>
         - Receipts by Plates IDs
       </small><br>
       <small>
         - Bulk or By Item Control
       </small><br>
       <small>
         - Dock Shipping Control
       </small><br>
       <small>
