...
<!--SECTION HEADING-->
    ...
    <div class="section-heading-page">
      <div class="container">
        <div class="row">
          <div class="col-sm-6">
            <h1 class="heading-page text-center-xs">WM Logistics</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb text-right text-center-xs">
              ...
              <li class="active">WM Logistics</li>
            </ol>
          </div>
        </div>
      </div>
...
<div class="col-sm-12">
       ...
       <h1>Warehouse Management and Logistics – We Optimize the flow of merchandise
       <br>
       <small>If you want to be key part of the global supply chain, you needs continue optimization of your Warehouse and Shipment complex activities. We created IMEXNet Logistics to improve your capabilities and mantain your business as a competitive partner.</small>   
       <br>
       <small>Efficiency in Shipping and Receiving of Merchandise, Control inventory and fast picking are part of our solution.</small>
       <br>
       <small>Our system can adapt to your requirements to extend your value int the supply chain</small> </h1>
...
<div class="text-center-xs">
       ...
       <br>
       <small>
         Merchandise Tracking – From receiving notification to delivery in one screen.      
       </small>
       <br>
       <small>
         Inventory – You can get control for your customers by Stock Products or by Received Shipment.
        </small>
       <br>
       <small>
...
<div class="col-sm-12">
       ...
       <h2>"We know that logistics service is your competitive differentiation. That is why IMEXNet Logistics was developed thinking for all size of operations. We guarantee to improve your customer satisfaction levels optimizing your Logistic processes."</h>
