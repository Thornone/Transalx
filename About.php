...
<div class="col-sm-12">
       ...
       <h1>About Us.
       <br>
       <small>Our mission is generate the best solution for your business</small>
       
      </h1>
      <h2><br>We want to serve you: <br>
        <small>Imexsol born in 2011 to generate innovative and flexible solutions for International Trade Service Providers.</small>
        <br>
        <small><br>Our vision is “Revolutionize the International Trade Community with integrated and inclusive solutions of Technology”.</small>
        <br>
        <small><br>We know what is needed to accomplish this task, is in our DNA we have more than 10 years developing and implementing solutions for International Trade Industry, and more than 15 years developing solutions of technology for International Companies around Mexico an United State. <br></small>
       <br>Our focus: Your business… <br>
       <small>We want to generate an specific solution for your Company. We can achieve this task with the integration between our tools, our experience and our development services.</small>
      </h2>
